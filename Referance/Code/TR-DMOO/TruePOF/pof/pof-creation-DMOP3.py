...
fName1 = "measures/pof/POF-nt10-taut10-DMOP3"
fName2 = "measures/pof/POF-nt10-taut25-DMOP3"
fName3 = "measures/pof/POF-nt10-taut50-DMOP3"
fName4 = "measures/pof/POF-nt10-taut5-DMOP3"
fName5 = "measures/pof/POF-nt1-taut10-DMOP3"
fName7 = "measures/pof/POF-nt1-taut50-DMOP3"
fName6 = "measures/pof/POF-nt20-taut10-DMOP3"
fName8 = "measures/pof/POF-nt20-taut50-DMOP3"
...
for j in range(0, 1001):
    ...
    for jj in range(0, 1001):
	  ...
	  if (j < 200):
	    ...
	    if (g < 0):
	      val = 1 + 72*math.pow(-g, 2)
	      f2 = 1 - math.sqrt(float(f1)/float(val))
	    else:
	      f2 = 1-math.sqrt(f1)
	    solution.append(f1)
	    solution.append(f2)
