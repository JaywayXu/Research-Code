    ...
    methods
        ...
        function [object, calls] = evaluate(object, Tasks, no_of_tasks)
            ...
            if object.skill_factor == 0
                ...
                for i = 1:no_of_tasks
                    [object.factorial_costs(i), funcCount] = fnceval(Tasks(i), object.rnvec);
                ...
                for i = 1:no_of_tasks
                    ...
                    if object.skill_factor == i
                        [object.factorial_costs(object.skill_factor), funcCount] = fnceval(Tasks(object.skill_factor), object.rnvec);
                        calls = funcCount;
                        break;
                    end
        ...
        function [object, calls] = evaluate_SOO(object, Task, p_il, options)
            [object.factorial_costs, funcCount] = fnceval(Task, object.rnvec);
            calls = funcCount;
        end
