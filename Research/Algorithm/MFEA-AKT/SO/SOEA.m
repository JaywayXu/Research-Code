function data_SOO = SOEA(Task,pop,gen,selection_process,p_il,reps,ncx)
            ...
            for i = 1 : pop/2     
                ...
                switch ncx
                    ...
                    case 7
                        a = rand(1,D);
                        b = rand(1,D);
                        child(count) = blxbcrossover(child(count),population(p1),population(p2),a,b);
                        child(count+1) = blxbcrossover(child(count+1),population(p2),population(p1),a,b);
                    case 8
                        child(count) = flowcrossover(child(count),population(p1),population(p2));
                        child(count+1) = flowcrossover(child(count+1),population(p2),population(p1));
                    case 9
