 ...
 * solutions.
 */
public class SpCrossover extends Crossover {
	/**
	...
	public SpCrossover(HashMap<String, Object> parameters) {
		super(parameters);
	...
	public Solution[] doCrossover(double probability, Solution parent1, Solution parent2,ProblemSet problemSet) throws JMException {
		...
		if (PseudoRandom.randDouble() <= probability) {
			...
			cutPoint=PseudoRandom.randInt(0, dim-1);
			
			for(i=cutPoint;i<dim;i++){
