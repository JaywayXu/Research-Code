function data_SOO = SOGBO(Task, pop, gen, pr, reps)
    % 单任务GBO
    ...
    for rep = 1:reps
        ...
        % 适应值评价
        parfor i = 1:pop
            [population(i), calls_per_individual(i)] = evaluate_SOO(population(i), Task);
        end
        ...
        while generation < gen
            ...
            for i = 1:pop
                ...
                [Chromosome_new, calls_per_individual(i)] = evaluate_SOO(Chromosome_new, Task);
