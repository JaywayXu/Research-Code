...
public class LZ09_F6 extends Problem {   
	LZ09 LZ09_ ; 
 /** 
  * Creates a default LZ09_F6 problem (10 variables and 3 objectives)
  ...
  */
   ...
   * @param solutionType The solution type must "Real" or "BinaryReal". 
   */
   public LZ09_F6(int numberOfObjectives, int numberOfVariabless) {
	   
		 Integer ptype=31; 
	     Integer dtype=1;
	     Integer ltype=32; 	   
     numberOfVariables_  = numberOfVariabless;
    ...
    */    
    public void evaluate(Solution solution) throws JMException {
      ...
      for (int i = 0; i < numberOfObjectives_; i++)
        solution.setObjective(startObjPos_+i, y.get(i)); 
    } // evaluate
} // LZ09_F6
