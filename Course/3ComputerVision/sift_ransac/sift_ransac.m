...
if nargin == 0
im1 = imread('sift_0.jpg') ;
im2 = imread('sift_2.jpg') ;
end
...
[f1,d1] = vl_sift(im1g, 'PeakThresh', 0) ;
[f2,d2] = vl_sift(im2g, 'PeakThresh', 0) ;
...
[f1(2,matches(1,:));f2(2,matches(2,:))],'Color','red') ;
line([f1(1,matches(1,ok));f2(1,matches(2,ok))+o], ...
[f1(2,matches(1,ok));f2(2,matches(2,ok))],'Color','blue') ;
