function data_MFEA1 = MFEA1(Tasks, pop, gen, selection_process, p_il, reps)
    % MFEA1 function: implementation of MFEA-I algorithm
    % Herein, the rmp = 0.3 and is fixed throughout the optimization process.
    ...
    if no_of_tasks <= 1
        error('At least 2 tasks required for MFEA-I');
    end
    ...
    fid1 = fopen('final_MFEA1.txt', 'w'); % prints final objective values for each independent run
    ...
    for rep = 1:reps
        ...
        rmp = 0.3; % fixed for all generations
        generation = 1;
        ...
        while generation < gen
            ...
            disp(['MFEA-I Generation = ', num2str(generation), ' best factorial costs = ', num2str(bestobj), '  rmp = ', num2str(rmp), ]); %
    ...
    data_MFEA1.wall_clock_time = toc;
    data_MFEA1.EvBestFitness = EvBestFitness;
    data_MFEA1.bestInd_data = bestInd_data;
    data_MFEA1.TotalEvaluations = TotalEvaluations;
