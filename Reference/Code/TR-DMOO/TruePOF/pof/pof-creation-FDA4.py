...
fName1 = "measures/pof/POF-nt10-taut10-FDA4"
fName2 = "measures/pof/POF-nt10-taut25-FDA4"
fName3 = "measures/pof/POF-nt10-taut50-FDA4"
fName4 = "measures/pof/POF-nt10-taut5-FDA4"
fName5 = "measures/pof/POF-nt1-taut10-FDA4"
fName7 = "measures/pof/POF-nt1-taut50-FDA4"
fName6 = "measures/pof/POF-nt20-taut10-FDA4"
fName8 = "measures/pof/POF-nt20-taut50-FDA4"
...
for j in range(0, 1001):
    ...
    for jj in range(0, 101):
     for kk in range(0, 101):
        ...
        solution = []
        if ((math.pow(f1,2) + math.pow(f2,2))<= 1):
          f3 = float(math.sqrt(abs(1.0 - math.pow(f1, 2) - math.pow(f2, 2))))
        else:
          break
        solution.append(f1)
        solution.append(f2)
