...
public class Binary extends Variable {
	 ...
	 * for examples the classes, <code>BinaryReal</code> and <code>BinaryInt
	 * <codes>. In this classes, the method allows to decode the value enconded
	 * in the binary string. As generic variables do not encode any value, this
	 * method do noting
	 */
	public void decode() {
		// do nothing
