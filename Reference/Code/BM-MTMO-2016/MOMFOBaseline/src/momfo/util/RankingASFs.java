...
public class RankingASFs {
	...
	/**
	 * Ranking solutions in frontiers considering several ASFs (one by each
	 * vector of weights)
	 * 
	 * @param solutionSet
	...
	public RankingASFs(SolutionSet solutionSet, AchievementScalarizingFunction asf, double[][] weights,
		...
		// List that contains the index of a solution and the value of the ASF
		// (one for each vector of weights)
		...
		// The list l is used to allow delete a solution when it is assigned to
		// a frontier
		// Each node in the list contain the index of the solution in the
		// SolutioSet because the size of the list changes
	 ...
	 *            The <code>SolutionSet</code> to be ranked
	 * @param asfInUtopian
	 *            The <code>AchievementScalarizingFunction</code> to be used in
	 *            the utopian point
	 * @param pairWeights
	 *            The weight vectors to be used for each
	 *            <code>AchievementScalarizingFunction</code> in the utopian
	 *            point
	 * @param asfInNadir
	 *            The <code>AchievementScalarizingFunction</code> to be used in
	 *            the nadir point
	...
	public RankingASFs(SolutionSet solutionSet, AchievementScalarizingFunction asfInUtopian, double[][] pairWeights,
		...
		// List that contains the index of a solution and the value of the ASFs
		// (one for each vector of weights)
		LinkedList<Node> l = new LinkedList<Node>();
		LinkedList<Node> solutionsToRemove = new LinkedList<Node>();
		Node bestNode;
	 ...
	 * positions, this method can be used to combine both set of weight vectors
	 * to generate the original set of weight vectors.
	 * 
	 * @param pairweights
	 *            A set of pair weight vectors (in a previous set of weight
	 *            vectors)
	 * @param oddWeights
	 *            A set of odd weight vectors (in a previous set of weight
	 *            vectors)
