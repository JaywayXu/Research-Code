...
%-- Focal length:
fc = [ 3275.011166400151978 ; 3279.714133739320914 ];

%-- Principal point:
cc = [ 1525.972527623571068 ; 2014.883021183562278 ];

%-- Skew coefficient:
alpha_c = 0.000000000000000;

%-- Distortion coefficients:
kc = [ 0.236917409835791 ; -1.050971954838207 ; -0.000209506051280 ; 0.000973058896581 ; 0.000000000000000 ];

%-- Focal length uncertainty:
fc_error = [ 10.421031892221601 ; 10.658588249543186 ];

%-- Principal point uncertainty:
cc_error = [ 7.447969691650223 ; 8.965475574597630 ];

%-- Skew coefficient uncertainty:
alpha_c_error = 0.000000000000000;

%-- Distortion coefficients uncertainty:
kc_error = [ 0.010488268698441 ; 0.074086801989058 ; 0.001178459991888 ; 0.000989277118126 ; 0.000000000000000 ];
